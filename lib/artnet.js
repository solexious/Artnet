...
var Artnet = function (config) {
    ...
    var frameDelay =       parseInt(config.frameDelay)          || 25;
    var minPackageLength = parseInt(config.minPackageLength)    || 0;
    var maxPackageLength = parseInt(config.maxPackageLength)    || 512;
    ...
    var artdmxPackage = function (universe, length) {
        ...
        if(minPackageLength > length) length = minPackageLength;
        else if(maxPackageLength < length) length = maxPackageLength;
